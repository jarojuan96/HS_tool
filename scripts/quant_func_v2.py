...
def emission_quantification (dxgas, ref_rad, mission, gas, path_folder, name, psave):
    
    mask, bool_det, source_coord = select_plume(dxgas, ref_rad, mission, gas)
    ...
    if gas == 'ch4':
        if bool_det: 
            ...
            Q, err_Q, u10, err_u10 = extract_Q(dxgas, mask, u10, mission, gas)
        else:
        ...
        if bool_det: 
            ...
            Q_1, err_Q_1, Q_2, err_Q_2, u10, err_u10 = extract_Q(dxgas, mask, u10, mission, gas)
        else:
