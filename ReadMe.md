...
- Plume quantification are only allowed for ch4 and nh3, although there might be potential extension to other gases in the future.
...
* Change the path of these files according to where you store them in 'variable_definitions.py'
